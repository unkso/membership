...
<head>
    <title>{lang}wcf.page.personnel.management.user{/lang} - {PAGE_TITLE|language}</title>

    {include file='headInclude' sandbox=false}
</head>

<body id="tpl{$templateName|ucfirst}">
    {include file='header' title='wcf.page.personnel.management.user.title'|language paddingBottom=30 light=true}
